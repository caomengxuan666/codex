...
fn derive_requested_execpolicy_amendment_returns_none_for_shell_and_powershell_variants() {
    for prefix_rule in [
        ...
        vec!["winuxsh".to_string()],
        vec!["winuxsh".to_string(), "-C".to_string()],
        vec!["winuxsh".to_string(), "-c".to_string()],
        vec!["winuxsh".to_string(), "--repl-command".to_string()],
        vec!["winuxsh.exe".to_string(), "-C".to_string()],
        vec!["winuxsh.exe".to_string(), "-c".to_string()],
        vec!["winuxsh.exe".to_string(), "--repl-command".to_string()],
